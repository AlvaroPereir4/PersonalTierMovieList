"""
Django settings for tierlistmovies project.
...
ROOT_URLCONF = 'tierlistmovies.urls'
...
WSGI_APPLICATION = 'tierlistmovies.wsgi.application'
...
STATICFILES_DIRS = ['../projects/6.project_api_movies/tierlistmovies/tierlistmovies/static']



#STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')
STATIC_ROOT = '../tierlistmovies/staticfiles'
